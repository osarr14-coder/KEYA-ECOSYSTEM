 ...
 * Lecture seule, même principe que `MyActionsView.tsx` (apps/home,
 * ticket 008) : purement informatif, aucun bouton « traiter » — pas une
 * régression, cette app n'en a jamais eu non plus. `GET /api/me/tasks/`
 * (ticket 006), déjà consommé pour le compteur (`taskInboxCount`, ticket
 * F-060), même filtre `status=pending` — la file ACTIONNABLE d'abord,
 * jamais un tableau de bord KPI au premier rendu (même doctrine que
 * `ProgramRequestsView.tsx`, ticket F-058).
 */
